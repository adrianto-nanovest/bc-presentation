...
export const f4Content = {
  ...
  facets: [
    ...
    },
    {
      ...
      essenceKw: ["metadata first", "triggered", "as needed"],
      icon: "Layers",
    },
    {
      id: "how-claude-picks",
...
export const f6Content = {
  ...
  facets: [
    ...
    },
    {
      ...
      essenceKw: ["auto-audit", "weekly-report"],
      icon: "CheckCircle",
    },
  ],
