...
export function E10HarnessWhatWhy() {
  ...
  return (
    <>
      ...
      >
        <Reveal on={showLeft} data-testid="e10-definition">
          <p
            style={{
        ...
        <Reveal
          on={showIncludes}
          delay={150}
          data-testid="e10-includes-package"
        >
          <div
            style={{
          ...
          >
            ...
            >
              <span
                data-testid="e10-includes-kicker"
                style={{
                  fontFamily: "var(--mono)",
                  fontSize: 11,
      ...
      >
        <Reveal on={showEq} data-testid="e10-equation">
          <div
            style={{
              display: "flex",
              alignItems: "baseline",
        ...
        <Reveal on={showEq} delay={650} data-testid="e10-quote">
          <div>
            <p
              style={{
                fontFamily: "var(--serif)",
        ...
        <Reveal on={showTagline} data-testid="e10-tagline">
          <p
            style={{
              fontFamily: "var(--display)",
              fontStyle: "italic",
