...
import { PenLine, Code2, Wrench, Eye, Sparkles, DollarSign } from "lucide-react";
...
function B4CategoryCard({ cat, active, onHover }: CardProps) {
  ...
  const shellStyle: CSSProperties = {
    ...
    border: "1px solid",
    borderColor: active ? "var(--copper-200)" : "var(--copper-700)",
    background: active ? "rgba(184,110,61,0.06)" : "rgba(10,10,10,0.6)",
    transition:
