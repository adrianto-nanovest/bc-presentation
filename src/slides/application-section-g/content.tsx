  ...
  quadrants: [
    {
      ...
      items: [
        ...
        { name: "Plan", essence: "design before you build", glyph: "lucide:ListTree" },
        { name: "Task", essence: "track work as you go", glyph: "lucide:CheckCircle" },
        { name: "general-purpose", essence: "the catch-all worker", glyph: "lucide:Wrench" },
        {
    ...
    },
    {
      ...
      items: [
        ...
        { name: "/resume", essence: "pick up a past session", glyph: "lucide:History" },
        { name: "/help", essence: "list everything you can ask", glyph: "lucide:Info" },
      ] as const,
    },
    {
      id: "tools",
      ...
      items: [
        { name: "Read", essence: "pull bytes off disk", glyph: "lucide:Eye" },
        { name: "Write", essence: "create a file", glyph: "lucide:NotebookPen" },
        { name: "Edit", essence: "exact-string replace in a file", glyph: "lucide:Wand2" },
        { name: "Bash", essence: "run a shell command", glyph: "lucide:Terminal" },
        { name: "Grep", essence: "ripgrep across the repo", glyph: "lucide:Search" },
        { name: "Glob", essence: "match files by pattern", glyph: "lucide:LayoutGrid" },
        { name: "WebFetch", essence: "pull a URL into context", glyph: "lucide:Globe" },
        { name: "WebSearch", essence: "search the web", glyph: "lucide:Telescope" },
      ] as const,
    },
    {
      id: "hooks",
      header: "HOOKS",
      items: [
        { name: "SessionStart", essence: "fires when you open Claude", glyph: "lucide:Zap" },
        {
        ...
        { name: "Stop", essence: "when Claude finishes a turn", glyph: "lucide:Square" },
      ] as const,
    },
  ] as const,
