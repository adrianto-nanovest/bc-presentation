/* global window */
// Section E content. Single source — sourced from project content.tsx.
...
const E4 = {
  ...
  tiers: [
    { id: "basic",        label: "BASIC",        copper: "copper-700", cards: [
    ...
    { id: "intermediate", label: "INTERMEDIATE", copper: "copper-500", cards: [
    ...
    { id: "advanced",     label: "ADVANCED",     copper: "copper-300", cards: [
...
const E6 = {
  ...
  satellites: [
    { id: "user-prompt", label: "User Prompt",         icon: "MessageSquare",
      hover: { kicker: "Layer 1 · the prompt itself",
    ...
    { id: "conv-mem",    label: "Conversation Memory", icon: "History",
      hover: { kicker: "Episodic memory · short‑term",
    ...
    { id: "rag",         label: "RAG Knowledge",       icon: "BookOpen",
      hover: { kicker: "Retrieval‑Augmented Generation",
    ...
    { id: "tools",       label: "Tools & APIs",        icon: "Wrench",
      hover: { kicker: "Actions in the world",
    ...
    { id: "persist",     label: "Persistent Memory",   icon: "Archive",
      hover: { kicker: "Semantic + episodic · long‑term",
    ...
    { id: "system",      label: "System Instructions", icon: "Shield",
      hover: { kicker: "Procedural memory · persistent rules",
...
Object.assign(window, { E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11 });
