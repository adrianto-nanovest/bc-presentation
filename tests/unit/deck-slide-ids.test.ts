...
/** 78 files under `src/slides/` plus `hexLadderDevSlide` in the registry — gh#34's
 ...
 *  land at the HEAD of a run that already existed) and `gap-no-sop` (gh#66, the
 *  tenth, and the first to land in the MIDDLE of one). A migration sentinel, not the
