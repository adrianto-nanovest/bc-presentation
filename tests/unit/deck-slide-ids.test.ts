...
/** 75 files under `src/slides/` plus `hexLadderDevSlide` in the registry — gh#34's
 ...
 *  sixth) and `invest-security` (gh#58, the seventh). A migration sentinel, not the
