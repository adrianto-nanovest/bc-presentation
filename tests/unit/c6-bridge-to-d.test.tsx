...
} from "@/slides/mindset-section-c/c6-bridge-to-d";
...
test("Bridge applies AmbientPulse (no underline) on `how` at canonical pose", () => {
  renderAtStep(1);
  ...
  // No underline — the AmbientPulse glow carries the emphasis on its own.
  expect(kw.style.textDecorationLine).toBe("");
